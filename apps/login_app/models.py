...
class UserManager(models.Manager):
    ...
    def createUser(self, postData):
        ...
        print agent
        return self.create(first_name = first_name, last_name = last_name, email = email, password = password, date = date, agent = agent)
...
class User(models.Model):
    ...
    def __str__(self):
        return "First_name: {}, last_name: {}, email: {}, password: {}, cpassword: {}, date:{}, leads: {}, agent: {}".format(self.first_name, self.last_name, self.email, self.password, self.cpassword, self.date, self.leads, self.agent)
